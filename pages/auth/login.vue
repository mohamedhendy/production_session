            ...
            >
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 px-6 py-20 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px]">
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="router.push('/sessions-production')">
                            <div>
                            ...
                            <ul class="flex justify-center gap-3.5">
                                <li>
                                    <a
                                        ...
                                        style="background: linear-gradient(135deg, rgb(18 239 61) 0%, rgba(67, 97, 238, 1) 100%)"
                                    >
                                        <icon-instagram />
                                    </a>
                                </li>
