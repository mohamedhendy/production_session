<template>
    <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
        ...
        <div class="form-group">
            <label class="capitalize"> {{ $t('content_ar') }} </label>
            <textarea v-model="content_ar" name="" id="" class="form-input" rows="6"></textarea>
        </div>
        <div class="form-group">
            <label class="capitalize"> {{ $t('content_en') }} </label>
            <textarea v-model="content_en" name="" id="" class="form-input" rows="6"></textarea>
        </div>
        <div class="">
