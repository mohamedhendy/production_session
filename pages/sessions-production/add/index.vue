    ...
    <div :class="lang == 'ar' ? 'is_ar' : 'is_en'">
        ...
        >
            ...
            >
                <div class="col-md-12">
                    <div class="border-bottom d-flex align-items-center">
                        ...
                        <div>
                            <content-type @has_images="is_has_images" @has_videos="is_has_videos"></content-type>
                        </div>
                    </div>
                </div>
            </tab-content>
            ...
            >
                ...
                <add-invoice v-for="(item, indexObj) in invoice" :key="indexObj" @addInvoice="setInvoice" :indexNumber="indexObj" @delete="deleteRow">
                </add-invoice>
                <div class="col-md-12">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setContent(data) {
                this.content.date = data.date;
                this.content.name = data.name;
                this.content.country_id = data.country_id;
                this.content.city_id = data.city_id;
            },
            ...
            async saveSession() {
                ...
                for (let i = 0; i < this.photographer.length; i++) {
                    ...
                    formdata.append(`entities[${i}][contract_image]`, this.photographer[i].contract_image);
                }
                ...
                for (let i = 0; i < this.representative.length; i++) {
                    ...
                    formdata.append(`entities[${i + step2}][legal_form_id]`, this.representative[i].legal_form_id);
                    ...
                    formdata.append(`entities[${i + step2}][contract_image]`, this.representative[i].contract_image);
                }
                ...
                for (let i = 0; i < this.location.length; i++) {
                    ...
                    formdata.append(`entities[${i + step3}][legal_form_id]`, this.location[i].legal_form_id);
                    ...
                    formdata.append(`entities[${i + step3}][contract_image]`, this.location[i].contract_image);
                }
                ...
                this.loading = true;
                await $fetch(`${this.apiUrl}/api/recording-session`, {
                    method: 'POST',
                    body: formdata,
                })
                    .then((res) => {
                    ...
                    .catch((err) => {
                        ...
                        Object.keys(err?.response?._data?.errors).forEach((key) => {
                            var errMSG = err?.response?._data?.errors[key][0];
                            setTimeout(() => {
                                Swal.fire({
                                    title: '',
                                    text: errMSG,
            ...
            async defaultContractContent(id) {
                await $fetch(`${this.apiUrl}/api/legal-form/${id}`, {
                    method: 'GET',
                }).then((res) => {
                    this.DefaultContract = res.data;
                });
                // .catch((err) => {
                //     this.loading = false;
                //     Swal.fire({
...
<style>
    ...
    .is_en .vue-form-wizard .wizard-card-footer {
        padding-left: 20px !important;
        padding-right: 20px !important;
    }
    ...
    .is_ar .vue-form-wizard .wizard-card-footer .wizard-footer-left {
        float: right !important;
    }
    .is_ar .vue-form-wizard .wizard-card-footer .wizard-footer-right {
