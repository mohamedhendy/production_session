<template>
    <div>
        ...
        <div class="space-y-8 pt-5">
            <h4 class="badge mb-0 inline-block bg-primary text-base hover:top-0">Pills</h4>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Text Only</h5>
                        <a
  ...
  &lt;/script&gt;
                ...
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Icon Only</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
  ...
  &lt;/script&gt;
                ...
                <div class="panel lg:col-span-2">
                    <div class="mb-5 flex items-center justify-between">
                        <h5 class="text-lg font-semibold dark:text-white-light">Text & Icon</h5>
                        <a
                            class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                            href="javascript:;"
  ...
  &lt;/script&gt;
            ...
            <!-- Circle -->
            <h4 class="badge mb-0 inline-block bg-primary text-base hover:top-0">Circle</h4>
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <!-- icon only -->
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
  ...
  &lt;/script&gt;
            ...
            <!-- Square -->
            <h4 class="badge mb-0 inline-block bg-primary text-base hover:top-0">Square</h4>
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <!-- icon only -->
                <div class="panel">
                    <div class="mb-5 flex items-center justify-between">
