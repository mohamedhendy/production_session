        ...
        <div class="shadow-sm">
            <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                    <NuxtLink to="/sessions-production" class="main-logo flex shrink-0 items-center">
                        <img class="ml-[5px] w-[120px] flex-none" src="https://arabsstock.com/img/logowa.svg" alt="">
                            ...
                            <Popper :placement="store.rtlClass === 'rtl' ? 'bottom-end' : 'bottom-start'" offsetDistance="8">
                                ...
                                <template #content="{ close }">
                                    <ul class="w-[300px] divide-y !py-0 text-dark dark:divide-white/10 dark:text-white-dark sm:w-[350px]">
                                        ...
                                        <template v-for="notification in notifications.slice(0,1)" :key="notification.id">
                                ...
                                <template #content="{ close }">
                                    <ul class="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                        ...
                                        <li class="border-t border-white-light dark:border-white-light/10">
                                            <NuxtLink to="/auth/login" class="!py-3 text-danger" @click="close()">
                ...
                <li class="menu nav-item relative">
                    <a href="javascript:;" class="nav-link">
                        <div class="flex items-center">
                            ...
                            <span class="px-2">{{ $t('sessionProductionManagement') }}</span>
                        </div>
